    ...
    <>
      ...
      <main>
        ...
        <div className="w-full my-12 mt-20">
          <>
            <div className="grid grid-cols-12 p-12 px-24 items-center">
            ...
            <div className="flex items-center p-12 px-24 mt-16">
              <div className="flex flex-col w-1/2 font-semibold gap-y-4">
                <div>
                  <h4 className="uppercase text-xs text-secondary">
                    why we started it
                  </h4>
            ...
            <div className="flex flex-row-reverse items-center p-12 px-24  gap-x-8">
              <div className="flex flex-col w-1/2 font-semibold gap-y-4">
                <div>
                  <h4 className="uppercase text-xs text-secondary">
                    Why we started it
