...
const Navbar = ({ white }: Props) => {
  ...
  return (
    <div className="w-full fixed flex justify-center top-0 left-0 z-50 ">
      <motion.header
        className={clsx(
          "w-full  max-w-[2048px] flex justify-center transition p-2 md:p-4 duration-500 ease-in-out",
      ...
      >
        ...
        >
          ...
          <div className="hidden md:flex items-center justify-between">
            <nav className="">
              <div className=" w-full flex items-center justify-between px-2 lg:px-6 2k:px-14 2k:pl-18 4k:px-20 4k:pl-24">
                <ul
                  className={clsx(
                    "flex h-full items-center gap-x-2 lg:gap-x-4 xl:text-base 2xl:text-[17px] 2k:text-xl 4k:text-2xl font-semibold text-center z-20",
                    white ? "" : "text-white"
                  )}
                >
