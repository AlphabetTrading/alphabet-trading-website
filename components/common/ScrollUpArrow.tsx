      ...
      <AnimatePresence>
        {scrollPosition > 100 && (
          <motion.button
            ...
            whileTap={{ scale: 1 }}
            className="flex items-center justify-center fixed bottom-10 right-10 h-12 w-12 p-2 drop-shadow-xl shadow-xl shadow-black/50 backdrop-brightness-95 text-white rounded-full bg-secondary"
          >
            <svg
