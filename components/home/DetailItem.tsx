...
const DetailItem = ({ index, title, descriptions, imageSrc }: Props) => {
  return (
    <div>
      <div
        className={clsx(
          "flex flex-col items-center justify-center p-8 md:p-12 lg:gap-x-8",
          index % 2 == 0 ? "lg:flex-row" : "lg:flex-row-reverse"
        )}
      >
        <div className="bg-[#086965]/20 w-4/5 h-64  md:w-1/3 lg:w-1/4 md:h-96 rounded-lg relative mb-20">
          <div className="bg-white w-full h-64 md:h-96 rounded-lg absolute z-10 top-8 left-8 md:top-12 md:left-12">
            <img
        ...
        >
          <h1 className="text-2xl text-center md:text-3xl font-semibold">{title}</h1>
