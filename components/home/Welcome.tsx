...
const Welcome = (props: Props) => {
  return (
    <div className="flex flex-col justify-center items-center gap-y-4 bg-[#086965]/20 py-20 relative px-5 md:px-14">
      ...
      <div className="w-full  sm:w-11/12 flex flex-col gap-y-2 my-24 justify-center items-center absolute top-0 right-0 left-0 bottom-0 z-10">
        <h1 className="text-2xl md:text-4xl font-semibold">Welcome to Alphabet Trading</h1>
        <p className="w-11/12 sm:w-3/4 md:w-3/5 text-center text-sm md:text-md lg:text-lg md:leading-6">
